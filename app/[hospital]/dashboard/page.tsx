  ...
  return (
    <div style={{ padding: '20px 24px', maxWidth: 960, margin: '0 auto', position: 'relative' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 12, marginBottom: 14 }}>
        ...
        <Link href={`/${slug}/or-verification`}>
          <div style={{
            borderRadius: 16, padding: 20, cursor: 'pointer',
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 10, marginBottom: 16 }}>
        {[
          { href: `/${slug}/sets`,      iconName: 'ti-list-check', label: 'Instrument Sets', color: '#00A9B8' },
          { href: `/${slug}/storage`,   iconName: 'ti-archive',    label: 'Storage Shelf',   color: '#0F766E' },
          { href: `/${slug}/inventory`, iconName: 'ti-package',    label: 'All Inventory',   color: '#6B7280' },
        ].map(q => (
