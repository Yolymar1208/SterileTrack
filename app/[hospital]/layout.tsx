...
export default function HospitalLayout({ children }: { children: React.ReactNode }) {
  ...
  const NAV = [
    ...
    { section: 'CSSD Workflow', items: [
      { href: `/${slug}/dispensing`,      label: 'Dispensing Area', icon: Send,           highlight: true },
      { href: `/${slug}/or-verification`, label: 'OR Verification', icon: ClipboardCheck, highlight: true, badge: 'or' },
      { href: `/${slug}/receiving`,       label: 'Receiving Area',  icon: Inbox,          highlight: true },
    ]},
    ...
    { section: 'Reports', items: [
      ...
      { href: `/${slug}/staff`,  label: 'Staff Directory', icon: Users },
    ]},
  ]
    ...
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <div className="md:hidden px-4 py-3 flex items-center gap-3"
          style={{ background: '#F8F9FB', borderBottom: '0.5px solid #DCDFE4' }}>
